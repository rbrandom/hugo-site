...
This is a Hugo-based academic website using the PaperMod theme, designed for academic professionals to showcase papers, courses, and books. The site is deployed via Netlify at https://spaceofreasons.netlify.app.
...
- `hugo new papers/paper-name/index.md` - Create new paper entry  
- `hugo new courses/course-name/index.md` - Create new course entry
- `hugo new books/book-name/index.md` - Create new book entry

## Site Architecture

### Content Structure
The site follows Hugo's content organization with three main sections:

- **Papers** (`content/papers/`) - Academic papers with PDFs, images, and metadata
- **Courses** (`content/courses/`) - Course materials with meeting folders containing PDFs and handouts  
- **Books** (`content/books/`) - Book information with chapters and supplementary materials

Each content type uses bundle structure (index.md + assets in same folder).
...
- Social icons configured for CV, email, office hours, etc.
- Main sections: books, courses, papers
...
### Papers
- Located in `content/papers/paper-name/`
- Include `index.md` with frontmatter, paper PDF, presentation slides, appendices
- Images auto-generated at multiple sizes for responsive display
...
### Books
- Located in `content/books/book-name/`  
- Chapter PDFs and cover images
- Metadata in `index.md` frontmatter
